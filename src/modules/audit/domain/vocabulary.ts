export const AUDIT_ACTIONS = {
  ...
  SUPPLIER_MANUFACTURING_CAPABILITY_UPDATED: "SUPPLIER_MANUFACTURING_CAPABILITY_UPDATED",
  DRAWING_SELECTION_SET_CREATED: "DRAWING_SELECTION_SET_CREATED",
  DRAWING_SELECTION_ITEM_ADDED: "DRAWING_SELECTION_ITEM_ADDED",
  DRAWING_SELECTION_ITEM_UPDATED: "DRAWING_SELECTION_ITEM_UPDATED",
  DRAWING_SELECTION_SET_LOCKED: "DRAWING_SELECTION_SET_LOCKED",
  ...
  PROJECT_ARCHIVE_GENERATION_REQUESTED: "PROJECT_ARCHIVE_GENERATION_REQUESTED",
  PROJECT_ARCHIVE_GENERATED: "PROJECT_ARCHIVE_GENERATED",
  ...
  ASSET_RELEASE_CREATED: "ASSET_RELEASE_CREATED",
  ASSET_RELEASE_VERSION_DRAFTED: "ASSET_RELEASE_VERSION_DRAFTED",
  ASSET_RELEASE_VERSION_PUBLISHED: "ASSET_RELEASE_VERSION_PUBLISHED",
  ASSET_RELEASE_VERSION_SUPERSEDED: "ASSET_RELEASE_VERSION_SUPERSEDED",
  ASSET_RELEASE_READ: "ASSET_RELEASE_READ",
  PROJECT_ASSET_REFERENCE_CREATED: "PROJECT_ASSET_REFERENCE_CREATED",
  PROJECT_ASSET_REFERENCE_READ: "PROJECT_ASSET_REFERENCE_READ",
  PROJECT_ASSET_REFERENCE_RETIRED: "PROJECT_ASSET_REFERENCE_RETIRED",
  PROJECT_ASSET_USAGE_CREATED: "PROJECT_ASSET_USAGE_CREATED",
  PROJECT_ASSET_USAGE_READ: "PROJECT_ASSET_USAGE_READ",
  PROJECT_ASSET_USAGE_RETIRED: "PROJECT_ASSET_USAGE_RETIRED",
  PROJECT_ASSET_DERIVATION_CREATED: "PROJECT_ASSET_DERIVATION_CREATED",
  PROJECT_ASSET_DERIVATION_READ: "PROJECT_ASSET_DERIVATION_READ",
  PROJECT_ASSET_USAGE_SNAPSHOT_READ: "PROJECT_ASSET_USAGE_SNAPSHOT_READ",
...
export const AUDIT_OBJECT_TYPES = {
  ...
  SUPPLIER_MANUFACTURING_CAPABILITY: "SUPPLIER_MANUFACTURING_CAPABILITY",
  DRAWING_SELECTION_SET: "DRAWING_SELECTION_SET",
  DRAWING_SELECTION_ITEM: "DRAWING_SELECTION_ITEM",
  ...
  ASSET_RELEASE_VERSION: "ASSET_RELEASE_VERSION",
  ASSET_COMPONENT_SNAPSHOT: "ASSET_COMPONENT_SNAPSHOT",
  PROJECT_ASSET_REFERENCE: "PROJECT_ASSET_REFERENCE",
  PROJECT_ASSET_USAGE: "PROJECT_ASSET_USAGE",
  PROJECT_ASSET_DERIVATION: "PROJECT_ASSET_DERIVATION",
  PROJECT_ASSET_USAGE_SNAPSHOT: "PROJECT_ASSET_USAGE_SNAPSHOT",
  ISSUE: "ISSUE",
...
export const ARCHIVE_VERSION_AUDIT_FIELDS = [
  "projectId",
  "archiveVersionId",
  "generationEventId",
  "version",
...
export const SUPPLIER_MANUFACTURING_CAPABILITY_AUDIT_FIELDS = [
  "projectId",
  "supplierReferenceId",
  "capabilityId",
  "categoryCode",
...
export const DRAWING_SELECTION_SET_AUDIT_FIELDS = [
  "projectId",
  "selectionSetId",
  "code",
  "title",
...
export const DRAWING_SELECTION_ITEM_AUDIT_FIELDS = [
  "projectId",
  "selectionSetId",
  "selectionItemId",
  "drawingId",
  "documentVersionId",
  "drawingNumberSnapshot",
  "drawingVersionSnapshot",
  "manufacturingCategoryCodeSnapshot",
  "processTagCodesSnapshot",
  "quantity",
  "spareQuantity",
  "requiredOn",
  "supplierReferenceId",
...
export const ASSET_RELEASE_AUDIT_FIELDS = [
  "technicalAssetId",
  "releaseId",
  "releaseCode",
  "releaseVersionId",
...
export const PROJECT_ASSET_AUDIT_FIELDS = [
  "projectId",
  "referenceId",
  "usageId",
  "derivationId",
  ...
  "status",
  "resourceVersion",
  "targetControlledDocumentVersionId",
  "targetMechanicalDrawingId",
  "targetFileId",
  "targetSourceFileId",
  "targetSourceFileSha256",
  "targetType",
  "targetDocumentVersion",
  "targetDocumentVersionStatus",
  "targetFileStatus",
  "acceptanceType",
  "frozenAt",
