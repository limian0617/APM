export const ALERT_SOURCE_TYPES = {
  ...
  PROCUREMENT_NOT_ORDERED: "PROCUREMENT_NOT_ORDERED",
  PROCUREMENT_LATE: "PROCUREMENT_LATE",
  PROCUREMENT_PENDING_ACCEPTANCE: "PROCUREMENT_PENDING_ACCEPTANCE",
  PROCUREMENT_CRITICAL_SHORTAGE: "PROCUREMENT_CRITICAL_SHORTAGE",
  PROCUREMENT_CHANGE_BLOCKED: "PROCUREMENT_CHANGE_BLOCKED",
  PROCUREMENT_DATA_STALE: "PROCUREMENT_DATA_STALE",
