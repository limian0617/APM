...
const projectRolesByPermission: Partial<Record<PermissionCode, ProjectRoleCode[]>> = {
  ...
  [PERMISSIONS.PROJECT_UPH_DEFINITION_MANAGE]: [PROJECT_ROLES.ENGINEER],
  [PERMISSIONS.PROJECT_UPH_COMMISSIONING_SIGNOFF]: [PROJECT_ROLES.ENGINEER],
  [PERMISSIONS.PROJECT_UPH_PUBLISH]: [PROJECT_ROLES.QUALITY],
  [PERMISSIONS.PROJECT_UPH_BATCH_MANAGE]: [PROJECT_ROLES.ENGINEER],
  [PERMISSIONS.PROJECT_UPH_BATCH_CONFIRM]: [PROJECT_ROLES.PROJECT_MANAGER],
  [PERMISSIONS.PROJECT_UPH_BATCH_LOCK]: [PROJECT_ROLES.QUALITY],
  ...
  [PERMISSIONS.KNOWLEDGE_REUSE_CONFIRM]: [PROJECT_ROLES.PROJECT_MANAGER, PROJECT_ROLES.QUALITY],
