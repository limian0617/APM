...
ALTER TYPE "AuditAction" ADD VALUE IF NOT EXISTS 'MECHANICAL_DRAWING_CLASSIFICATION_UPDATED';
ALTER TYPE "AuditAction" ADD VALUE IF NOT EXISTS 'MANUFACTURING_CATEGORY_CREATED';
ALTER TYPE "AuditAction" ADD VALUE IF NOT EXISTS 'MANUFACTURING_CATEGORY_UPDATED';
ALTER TYPE "AuditAction" ADD VALUE IF NOT EXISTS 'MANUFACTURING_CATEGORY_STATUS_CHANGED';
ALTER TYPE "AuditAction" ADD VALUE IF NOT EXISTS 'PROCESS_TAG_CREATED';
ALTER TYPE "AuditAction" ADD VALUE IF NOT EXISTS 'PROCESS_TAG_UPDATED';
ALTER TYPE "AuditAction" ADD VALUE IF NOT EXISTS 'PROCESS_TAG_STATUS_CHANGED';
ALTER TYPE "AuditObjectType" ADD VALUE IF NOT EXISTS 'MANUFACTURING_CATEGORY';
ALTER TYPE "AuditObjectType" ADD VALUE IF NOT EXISTS 'PROCESS_TAG';
